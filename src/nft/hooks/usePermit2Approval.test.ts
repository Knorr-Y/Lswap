...
describe('usePermit2Approval', () => {
  it('sets spender of the correct UR contract from NFT side', async () => {
    ...
    console.log(UNIVERSAL_ROUTER_ADDRESS(1), 'UNIVERSAL_ROUTER_ADDRESS(1)')
    // renderHook(() => usePermit2Approval(USDCAmount, undefined, '0xb5088D94A080BddAee4a8a424aD8c4d8515EB09f'))
    // expect(mockUsePermit2Allowance).toHaveBeenCalledWith(USDCAmount, '0xb5088D94A080BddAee4a8a424aD8c4d8515EB09f')
  })
})
