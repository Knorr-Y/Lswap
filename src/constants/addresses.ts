...
// console.log(V3_FACTORY_ADDRESS,"V3_FACTORY_ADDRESS")
...
export const V3_CORE_FACTORY_ADDRESSES: AddressMap = {
  ...constructSameAddressMap('0xC408225185672b461585434721FC648ED3747CC6', [
...
//MULTICALL_ADDRESS合约地址是用于批量执行多个函数调用的合约。它是 Uniswap V3 版本中引入的一个特性，旨在提高交易的效率和降低成本。
export const MULTICALL_ADDRESS: AddressMap = {
  ...constructSameAddressMap('0x60351879Fe4C1A08A782448B70169d1c04Eac873', [
    SupportedChainId.OPTIMISM,
    SupportedChainId.POLYGON_MUMBAI,
    SupportedChainId.POLYGON,
  ]),
...
//通过GOVERNANCE_ALPHA_V0_ADDRESSES，Uniswap 协议可以轻松地访问和使用 Alpha V0 版本的治理合约地址，以实现相应的治理功能。这些治理功能可能包括提案提交、投票、参数设定等，以确保 Uniswap 协议的运行和发展符合社区的共识和期望。
/**
...
//TIMELOCK_ADDRESS是 Uniswap 协议中的时间锁合约地址。时间锁合约是一种安全机制，用于限制对协议关键功能的修改和升级。
export const TIMELOCK_ADDRESS: AddressMap = constructSameAddressMap('0x1a9C8182C09F50C8318d769245beA52c32BE35BC')

//MERKLE_DISTRIBUTOR_ADDRESS合约地址是用于实施空投或分发代币的Merkle分发器合约的地址。
export const MERKLE_DISTRIBUTOR_ADDRESS: AddressMap = {
  [SupportedChainId.MAINNET]: '0x090D4613473dEE047c3f2706764f49E0821D256e',
}

//ARGENT_WALLET_DETECTOR_ADDRESS是 Uniswap 协议中的一个常量，用于存储 Argent 钱包检测器合约的地址。
export const ARGENT_WALLET_DETECTOR_ADDRESS: AddressMap = {
  [SupportedChainId.MAINNET]: '0xeca4B0bDBf7c55E9b7925919d03CbF8Dc82537E8',
}

export const QUOTER_ADDRESSES: AddressMap = {
  ...constructSameAddressMap('0x1db95C4d1f76B09A17E8dae1565DB0eFfA899956', [
    SupportedChainId.OPTIMISM,
    SupportedChainId.ARBITRUM_ONE,
    SupportedChainId.POLYGON_MUMBAI,
    SupportedChainId.POLYGON,
...
export const NONFUNGIBLE_POSITION_MANAGER_ADDRESSES: AddressMap = {
  ...constructSameAddressMap('0x2e7744a6543B1B03E0875E9e673Acc3929a8E41a', [
    SupportedChainId.OPTIMISM,
    SupportedChainId.ARBITRUM_ONE,
    SupportedChainId.POLYGON_MUMBAI,
    SupportedChainId.POLYGON,
...
//ENS_REGISTRAR_ADDRESSES合约地址是Uniswap协议中用于存储ENS（以太坊名称服务）注册器合约地址的地址映射合约。
export const ENS_REGISTRAR_ADDRESSES: AddressMap = {
  [SupportedChainId.MAINNET]: '0x00000000000C2E074eC69A0dFb2997BA6C7d2e1e',
  [SupportedChainId.GOERLI]: '0x00000000000C2E074eC69A0dFb2997BA6C7d2e1e',
}

//SOCKS_CONTROLLER_ADDRESSES 是 Uniswap 协议中的一个合约地址，用于管理 SOCKS（Serialized Off-Chain Key Sets）控制器。SOCKS 控制器是一种用于管理和控制合约的权限系统。
export const SOCKS_CONTROLLER_ADDRESSES: AddressMap = {
  [SupportedChainId.MAINNET]: '0x65770b5283117639760beA3F867b69b3697a91dd',
}

//TICK_LENS_ADDRESSES是与 Uniswap 协议相关的合约地址之一。具体来说，TICK_LENS_ADDRESSES合约可能是用于存储与 Uniswap v3 的 TickLens 相关的地址信息。
export const TICK_LENS_ADDRESSES: AddressMap = {
  ...
  // [SupportedChainId.POLYGON_MUMBAI]: "0x1FE782Af642cED1F499BF05159f39b4DD5519E32",
}
